...
def load_graphs_only():
    ...
    with Neo4jManager(db_config) as neo4j_manager:
        ...
        graph1 = load_graph_from_cypher_file(neo4j_manager, "../data/macm_files/wrong_architecture.macm")
        
        # Load second graph (correct architecture)
        logger.info("Loading correct_architecture.macm...")
        graph2 = load_graph_from_cypher_file(neo4j_manager, "../data/macm_files/correct_architecture.macm")
