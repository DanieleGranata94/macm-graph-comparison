...
class AppConfig:
    ...
    # File paths
    cypher_file_1: str = "data/macm_files/wrong_architecture.macm"
    cypher_file_2: str = "data/macm_files/correct_architecture.macm"
...
def get_config() -> tuple[DatabaseConfig, AppConfig]:
    ...
    app_config = AppConfig(
        cypher_file_1=os.getenv("CYPHER_FILE_1", "data/macm_files/wrong_architecture.macm"),
        cypher_file_2=os.getenv("CYPHER_FILE_2", "data/macm_files/correct_architecture.macm"),
