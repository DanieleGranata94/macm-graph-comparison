...
class GraphComparisonApp:
    ...
    def run(self, file1: str = None, file2: str = None) -> None:
        ...
        """
        try:
            # Use provided files or fall back to config
            cypher_file1 = file1 or self.app_config.cypher_file_1
            cypher_file2 = file2 or self.app_config.cypher_file_2
...
def main():
    ...
    if args.log_file:
        app_config.log_file = args.log_file
    if args.output_format:
        app_config.output_format = args.output_format
